...
| — | [`diagrams/`](docs/diagrams/) | [system context](docs/diagrams/context.md) · ER model · request lifecycle and events · worker decision · audit-request states · audit states |
